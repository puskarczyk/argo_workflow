...
EXPECTED_COLUMNS = ["step", "type", "amount", "nameOrig", "oldbalanceOrg", "newbalanceOrig", "nameDest", "oldbalanceDest", "newbalanceDest", "isFraud",]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--report", required=True, help="Path to save validation_report.json")
