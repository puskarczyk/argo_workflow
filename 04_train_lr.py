...
def train(data_dir: str, out_dir: str, max_iter: int, random_state: int) -> None:
    ...
    model = LogisticRegression(solver="saga", max_iter=max_iter, random_state=random_state, n_jobs=-1,)
    ...
    print(f"[Training] Model {out_dir}/model.joblib")
    print(f"[Training] Metrics {out_dir}/metrics.json")
